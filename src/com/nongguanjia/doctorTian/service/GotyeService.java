...
import com.nongguanjia.doctorTian.LoginActivity;
import com.nongguanjia.doctorTian.MainActivity;
import com.nongguanjia.doctorTian.R;
import com.nongguanjia.doctorTian.app.AppApplication;
import com.nongguanjia.doctorTian.utils.AppUtil;
...
public class GotyeService extends Service implements NotifyListener {
	...
	public void onCreate() {
		...
		AppApplication.loadSelectedKey(this);
		if(!TextUtils.isEmpty(AppApplication.IP)){
			api.setNetConfig(AppApplication.IP, AppApplication.PORT);
		}else{
			//使用默认
			api.setNetConfig("", -1);
		}
		int code = api.init(getBaseContext(), AppApplication.APPKEY);
	...
	public static String[] getUser(Context context) {
		SharedPreferences sp = context.getSharedPreferences(LoginActivity.CONFIG,
