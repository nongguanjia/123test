...
public class VoiceToTextUtil implements OnEventListener,
	...
	public VoiceToTextUtil(ChatActivity chatPage,VoiceRecognitionClient mASREngine) {
	...
	public boolean onStartListening() {
		...
		if (code != VoiceRecognitionClient.START_WORK_RESULT_WORKING) {
			Toast.makeText(chatPage, "启动语音识别失败:" + code, Toast.LENGTH_LONG).show();
			pressEnd(null);
		} else {
